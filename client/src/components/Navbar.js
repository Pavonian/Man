    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Man</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/faces">
            <ListItem button key="Face">
              ...
              <ListItemText className="menu-text" primary="Face" />
            </ListItem>
          </Link>{" "}            
           <Link to="/faces">
            <ListItem button key="Face">
           ...
           <Link to="/earses">
            <ListItem button key="ears">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="ears" />
            </ListItem>
          </Link>{" "}            
           <Link to="/eyeses">
            <ListItem button key="eyes">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="eyes" />
            </ListItem>
          </Link>{" "}            
           <Link to="/mans">
            <ListItem button key="man">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="man" />
            </ListItem>
          </Link>{" "}            
           <Link to="/mans">
            <ListItem button key="man">
